// tweaks.jsx — floating tweak panel + form controls. Translated from the
// "omelette starter" scaffold. The host-protocol postMessage bits are kept as
// harmless no-ops in standalone use; the panel opens on `?tweaks=1` so it's
// still reachable in dev.
...
// (__edit_mode_set_keys → host rewrites the EDITMODE block on disk). In
// standalone use the postMessage is a harmless cross-frame no-op.
